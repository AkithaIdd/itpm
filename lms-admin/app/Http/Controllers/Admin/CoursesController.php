...
class CoursesController extends Controller
{
    ...
    public function store(StoreCoursesRequest $request)
    {
        ...
        $course->teacher()->sync(array_filter((array)$request->input('teacher')));
    ...
    public function update(UpdateCoursesRequest $request, $id)
    {
        ...
        $course->updateMedia($media, 'image');
    ...
    public function show($id)
    {
        ...
        $teachers = \App\User::get()->pluck('name', 'id');
$coursematerials = \App\Coursematerial::where('coursename_id', $id)->get();$assignments = \App\Assignment::where('coursename_id', $id)->get();$libraries = \App\Library::where('coursename_id', $id)->get();

        $course = Course::findOrFail($id);

        return view('admin.courses.show', compact('course', 'coursematerials', 'assignments', 'libraries'));
    }
